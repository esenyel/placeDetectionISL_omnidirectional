...
int main (int argc, char** argv)
{
    ...
    location_path = detector.debugFilePath;
    location_path.append("\locations.txt");

    std::ifstream fin;

    std::cout << "location_path" << location_path << std::endl;

    fin.open (location_path.c_str());
    ...
    base_point_locations.create(row1,col,CV_32F);
